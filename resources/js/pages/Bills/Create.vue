...
const onPurchaseOrderChange = () => {
  if (form.purchase_order_id) {
    ...
    if (po) {
      form.supplier_id = po.supplier.supplier_name; // This might need adjustment based on your data structure
      form.subtotal = po.total_amount;
      calculateTaxFromRate(12); // Default 12% VAT
    }
  }
};
