    ...
    <section class="max-w-7xl mx-auto py-12 px-4 md:px-8 -mt-8 relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        <div
          v-for="plan in plans"
          :key="plan.plan_id"
          class="relative bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
          :class="plan.plan_id === lastSubscriptionPlanId ? 'ring-2 ring-green-500 scale-105' : ''"
        >
          ...
          <div v-if="plan.plan_id === lastSubscriptionPlanId" 
            ...
            <span class="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-1 rounded-full text-sm font-semibold shadow-lg">
              Last Subscription
            </span>
          </div>
          ...
          <div class="p-8">
            ...
            <div class="mb-8">
              <ul class="space-y-3">
                <li class="flex items-center">
                  ...
                  <span class="text-gray-700">Restaurant Management</span>
                </li>
                <li class="flex items-center">
                  <svg class="h-5 w-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            ...
            <form method="POST" :action="route('subscriptions.create')" @submit="handleSubmit">
      ...
      <div v-if="subscriptions.length" class="mt-16">
        <div class="bg-white rounded-2xl shadow-xl p-8">
          <div class="flex items-center mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-900">Your Subscriptions History</h2>
          </div>
          ...
          <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-blue-600">{{ sub.remaining_days }}</span>
              </div>
            </div>
          </div>
        </div>
